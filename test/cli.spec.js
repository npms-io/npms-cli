...
describe(chalk.cyan('==> npms search cli'), () => {
    ...
    it('should return results using default size [10 results] using default `table` output ', (done) => {
        childProcess.exec(`node ${cmd} search gulp`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
    ...
    it('should return results using default size [10 results] in json format', (done) => {
        childProcess.exec(`node ${cmd} search gulp --output json`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
    ...
    it('should start with offset [--from, -f]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --size 3 --from 2`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
    ...
    it('should limit results to defined size [--size, -s]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --output json --size 2`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
            const resultObj = JSON.parse(stdout)
    ...
    it('should return result in JSON format [--output json, -o json]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --output json --size 1`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
            const resultObj = JSON.parse(stdout)
    ...
    it('should scoreEffect [--scoreEffet]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --scoreEffect 1 --size 3`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
    ...
    it('should return qualityWeight [--qualityWeight]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --scoreEffect 1 --size 2`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
    ...
    it('should return popularityWeight [--popularityWeight]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --popularityWeight --size 1`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
            stdout.should.contain('https://github.com/gulpjs/gulp')
            done()
        })
    ...
    it('should return maintenanceWeight [--maintenanceWeight]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --maintenanceWeight --size 1`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
            stdout.should.contain('https://github.com/gulpjs/gulp')
            done()
        })
    ...
    it('should show version [--help, -h]', (done) => {
        childProcess.exec(`node ${cmd} search gulp --help`, 'utf8', (err, stdout, stderr) => {
            if (err) { throw err }
